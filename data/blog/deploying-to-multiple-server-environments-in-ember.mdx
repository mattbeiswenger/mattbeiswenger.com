...
description: Learn how to deploy your Ember application to multiple environments by separating your build environments from your deployment environments
created: 05-14-2021
---
...
applications so hopefully this helped to distill some confusion.
